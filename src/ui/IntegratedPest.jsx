...
const IntegratedPestManagement = () => {
  ...
  useEffect(() => {
    const fetchIntegratedPestManagementProducts = async () => {
      try {
        setLoading(true);
        // Fetch categories
        ...
        // Find the "Integrated Pest Management" category
        ...
        console.error("Error fetching Integrated Pest Management products:", error);
      } finally {
        setLoading(false);
      }
    };

    fetchIntegratedPestManagementProducts();
  }, []);
